  ...
  public: {
    Tables: {
      ...
      bankruptcy_stage_files: {
        ...
        Relationships: [
          {
            foreignKeyName: "bankruptcy_stage_files_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "bankruptcy_stage_files_stage_id_fkey"
            columns: ["stage_id"]
            isOneToOne: false
            referencedRelation: "bankruptcy_stages"
            referencedColumns: ["id"]
          },
        ]
      }
      bankruptcy_stages: {
        ...
        Relationships: [
          {
            foreignKeyName: "bankruptcy_stages_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
      ...
      client_cabinet_tokens: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_cabinet_tokens_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
